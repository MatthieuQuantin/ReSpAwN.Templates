...
public abstract class BaseArchitectureTests
{
    ...
    protected readonly Assembly DomainContractsAssembly = typeof(PersonId).Assembly ?? throw new InvalidOperationException($"Assembly {DomainContractsAssemblyName} not found.");
