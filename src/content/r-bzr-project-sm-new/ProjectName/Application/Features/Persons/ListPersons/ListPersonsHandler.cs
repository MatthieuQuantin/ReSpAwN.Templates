...
internal sealed class ListPersonsHandler(IProjectNameReadRepository<Person> repository, IValidator<ListPersonsQuery> validator, ILogger<ListPersonsHandler> logger) : IQueryHandler<ListPersonsQuery, Result<List<PersonResult>>>
{
