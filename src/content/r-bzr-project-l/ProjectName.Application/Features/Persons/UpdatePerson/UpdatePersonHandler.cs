...
internal sealed class UpdatePersonHandler(IProjectNameRepository<Person> repository, IValidator<UpdatePersonCommand> validator, ILogger<UpdatePersonHandler> logger)
