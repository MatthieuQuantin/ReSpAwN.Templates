...
public abstract class BaseArchitectureTests
{
    ...
    protected readonly Assembly DomainContractsAssembly = typeof(SampleCreatedDomainEvent).Assembly ?? throw new InvalidOperationException($"Assembly {DomainContractsAssemblyName} not found.");
